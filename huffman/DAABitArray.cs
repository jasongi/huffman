...
namespace Asgn
{
    ...
    {
        /// <summary>
        /// The list of bits manipulated by this class.
        /// </summary>
        private List<bool> m_bits;

        /// <summary>
        /// The string which the bits encode to for display.
        /// </summary>
        public static string encoding = " ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789\n";
        ...
        public DAABitArray Append(bool bitVal)
        {
            // Append the new bit
            m_bits.Add(bitVal);
            return this; // allow recursion
        }
        ...
        /// <summary>
        /// Delete the first bit from the bit array and return it.
        /// </summary>
        public bool pop()
        {
            // Remove the last bit added
            bool retVal = m_bits[0];
            m_bits.RemoveAt(0);
            return retVal;
        }
        ...
        public uint GetBitRange(int startBitIdx, int endBitIdx)
        {
            int iNumBits;
            uint iBitSetVal;
        ...
        /// <summary>
        /// Convert 6 encoded bits to text to display as compressed text.
        /// </summary>
        /// <param name="index">Index of the first bit in the six bit word.</param>
        /// <returns>The character which represents the six bits</returns>
        public char SixToChar(int index)
        {
            return encoding[(int)GetBitRange(index, index + 5)];
        }
